...
image:https://img.shields.io/maven-central/v/com.noenv/vertx-wiremongo["Maven Central",link="https://search.maven.org/artifact/com.noenv/vertx-wiremongo"]
...
----
compile 'com.noenv:vertx-wiremongo:3.9.0'
----
